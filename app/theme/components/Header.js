  ...
  const headerTheme = {
    ...
    height:
      variables.platform === 'ios' && variables.platformStyle === 'material'
        ? variables.toolbarHeight + (StatusBar.height || 10)
        : variables.toolbarHeight,
    elevation: 3,
    shadowColor: platformStyle === 'material' ? '#b8b8b86e' : undefined,
    shadowOffset:
      platformStyle === 'material' ? { width: 0, height: 5 } : undefined,
    shadowOpacity: 1,
    shadowRadius: platformStyle === 'material' ? 3 : undefined,
    top: 0,
    left: 0,
    right: 0,
  };
